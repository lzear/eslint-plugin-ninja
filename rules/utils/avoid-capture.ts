...
const isValidIdentifier = (name: string | unknown) => {
...
```
*/
const isUnresolvedName = (name: string, scope: Scope.Scope) =>
...
export default (
  name: string,
  scopes: Scope.Scope[],
  isSafe: (name: string, scopes: Scope.Scope[]) => boolean = alwaysTrue,
) => {
