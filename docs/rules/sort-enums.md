...
- [Rule source](https://github.com/lzear/eslint-plugin-dont/blob/main/rules/sort-enums.ts)
- [Test source](https://github.com/lzear/eslint-plugin-dont/blob/main/test/sort-enums.test.ts)
