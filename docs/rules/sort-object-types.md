...
- [Rule source](https://github.com/lzear/eslint-plugin-dont/blob/main/rules/sort-object-types.ts)
- [Test source](https://github.com/lzear/eslint-plugin-dont/blob/main/test/sort-object-types.test.ts)
